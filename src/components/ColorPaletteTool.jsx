    ...
    <div className="DivToolContainer">
      ...
      <div className="DivToolContainerSide right DivPhonePreview">
        <div className="DivPhone PreviewBackgroundRoot">
          <div className="DivPreviewBlobLarge PreviewBackgroundPrimary PreviewBlobTopLeft"></div>
          <div className="DivPreviewBlobLarge PreviewBackgroundSecondary PreviewBlobBottomRight"></div>
        </div>
        <div className="DivPhone PreviewBackgroundRoot">
